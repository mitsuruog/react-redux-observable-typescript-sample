...
var pipe_1 = __webpack_require__(70);
/**
...
exports.MAP_READY = "@@map/READY";
exports.WEATHER_GET = "@@weather/GET";
exports.WEATHER_SET = "@@weather/SET";
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createEpicMiddleware__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ActionsObservable__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__combineEpics__ = __webpack_require__(88);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EPIC_END__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__operators__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_from__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__operators__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_operator_filter__ = __webpack_require__(85);
...
Object.defineProperty(exports, "__esModule", { value: true });
var typesafe_actions_1 = __webpack_require__(110);
var constants_1 = __webpack_require__(6);
exports.weatherGetAction = typesafe_actions_1.createAction(constants_1.WEATHER_GET, function (params) {
    if (params === void 0) { params = {}; }
    return ({
        type: constants_1.WEATHER_GET,
        params: params,
    });
});
exports.weatherSetAction = typesafe_actions_1.createAction(constants_1.WEATHER_SET, function (payload) {
    if (payload === void 0) { payload = {}; }
    return ({
        type: constants_1.WEATHER_SET,
        payload: payload,
    });
});
exports.mapReadyAction = typesafe_actions_1.createAction(constants_1.MAP_READY, function () { return ({
    type: constants_1.MAP_READY
}); });
...
var redux_observable_1 = __webpack_require__(23);
var react_redux_1 = __webpack_require__(5);
var App_connect_1 = __webpack_require__(107);
/**
 * Redux store setup
 */
...
function configureStore(initialState) {
    ...
    var middlewares = [
        redux_observable_1.createEpicMiddleware(epics_1.default),
    ];
    // compose enhancers
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(9), __webpack_require__(60)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_operator_map__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operator_switchMap__ = __webpack_require__(75);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ActionsObservable__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__EPIC_END__ = __webpack_require__(40);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
    ...
    return function (next) {
      ...
      (_context = __WEBPACK_IMPORTED_MODULE_1_rxjs_operator_map__["map"].call(epic$, function (epic) {
        var vault = process.env.NODE_ENV === 'production' ? store : {
          getState: store.getState,
          dispatch: function dispatch(action) {
            __webpack_require__(87).deprecate('calling store.dispatch() directly in your Epics is deprecated and will be removed. Instead, emit actions through the Observable your Epic returns.\n\n  https://goo.gl/WWNYSP');
...
var IteratorObservable_1 = __webpack_require__(81);
var ArrayObservable_1 = __webpack_require__(14);
var ArrayLikeObservable_1 = __webpack_require__(82);
var iterator_1 = __webpack_require__(13);
var Observable_1 = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_observable_merge__ = __webpack_require__(89);
...
var identity_1 = __webpack_require__(91);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(4);
var Map_connect_1 = __webpack_require__(109);
var Weather_connect_1 = __webpack_require__(117);
...
var mapStateToProps = function (state) { return ({}); };
var mapDispatchToProps = function (dispatch, props) { return ({
    getWeather: function (payload) { return dispatch(actions_1.weatherGetAction(payload)); },
    mapReady: function () { return dispatch(actions_1.mapReadyAction()); },
}); };
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__type_utils__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__get_type__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__is_action_of__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__create_action__ = __webpack_require__(114);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(4);
var scriptjs = __webpack_require__(116);
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_redux_1 = __webpack_require__(5);
var Weather_1 = __webpack_require__(118);
var mapStateToProps = function (state) { return ({
...
exports.Weather = function (_a) {
    ...
    return (React.createElement("div", { className: "weather" },
        ...
        React.createElement("dl", null,
            React.createElement("dt", null, "Weather"),
            React.createElement("dd", null,
                ...
                React.createElement("small", null,
                    ...
                    ")")),
            React.createElement("dt", null, "Temperature(Max/Min)"),
            React.createElement("dd", null,
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(7);
var WeatherReducer_1 = __webpack_require__(120);
var MapReducer_1 = __webpack_require__(122);
var reducers = redux_1.combineReducers({
    weather: WeatherReducer_1.weatherReducer,
    map: MapReducer_1.mapReducer,
});
...
Object.defineProperty(exports, "__esModule", { value: true });
var Weather_1 = __webpack_require__(121);
var constants_1 = __webpack_require__(6);
var initialState = {
    loading: false,
};
exports.weatherReducer = function (state, action) {
    ...
    switch (action.type) {
        case constants_1.WEATHER_SET:
            return Object.assign({}, state, { weather: new Weather_1.default(action.payload) });
        default:
            return state;
    }
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_observable_1 = __webpack_require__(23);
var WeatherEpic_1 = __webpack_require__(124);
var epics = redux_observable_1.combineEpics.apply(void 0, WeatherEpic_1.default);
...
var actions_1 = __webpack_require__(48);
var constants_1 = __webpack_require__(6);
var Api_1 = __webpack_require__(128);
var weatherGetEpic = function (action$, state) {
    return action$.ofType(constants_1.WEATHER_GET)
        .mergeMap(function (action) {
        return Api_1.getWeather(action.params.lat, action.params.lng)
            .map(function (payload) { return actions_1.weatherSetAction(payload); });
    });
};
exports.default = [
    weatherGetEpic,
...
var getWeather = function (lat, lon) {
    var request = fetch("https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&units=metric&APPID=49f8541c5e9d0758175574596d1f532e")
        .then(function (response) { return response.json(); });
    return Observable_1.Observable.from(request);
};
...
var Observable_1 = __webpack_require__(0);
var from_1 = __webpack_require__(38);
